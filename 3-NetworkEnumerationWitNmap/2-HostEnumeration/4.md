...
```shell-session
[!bash!]$ sudo nmap 10.129.2.28 -p- -sV
...
```shell-session
[!bash!]$ sudo nmap 10.129.2.28 -p- -sV --stats-every=5s
...
```shell-session
[!bash!]$ sudo nmap 10.129.2.28 -p- -sV -v 
...
```shell-session
[!bash!]$ sudo tcpdump -i eth0 host 10.10.14.2 and 10.129.2.28
